...
class OrderLine implements ModelInterface, ArrayAccess
{
     ...
     * Sets reference
     *
     * @param string $reference Article number, SKU or similar. (max 64 characters)
     *
     * @return $this
     */
     ...
     * Sets quantity_unit
     *
     * @param string $quantity_unit Unit used to describe the quantity, e.g. kg, pcs... If defined has to be 1-8 characters
     *
     * @return $this
     */
     ...
     *
     * @param int $total_discount_amount Non-negative minor units. Includes tax.  Example: 25 euros should be 2500
     *
     * @return $this
     */
     ...
     * Sets merchant_data
     *
     * @param string $merchant_data Property used to store additional metadata per item that will be returned whenever an order is read from Klarna. Pass through field. (max 1024 characters).
     *
     * @return $this
     */
     ...
     * Sets product_url
     *
     * @param string $product_url URL to the product page that can be later embedded in communications between Klarna and the customer. (max 1024 characters)
     *
     * @return $this
     */
     ...
     * Sets image_url
     *
     * @param string $image_url URL to an image that can be later embedded in communications between Klarna and the customer. (max 1024 characters)  Improves post-purchase customer experiences.
     *
     * @return $this
     */
