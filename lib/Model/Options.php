...
class Options implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['require_validate_callback_success'] = isset($data['require_validate_callback_success']) ? $data['require_validate_callback_success'] : false;
        $this->container['acquiring_channel'] = isset($data['acquiring_channel']) ? $data['acquiring_channel'] : null;
        $this->container['vat_removed'] = isset($data['vat_removed']) ? $data['vat_removed'] : false;
        $this->container['allow_separate_shipping_address'] = isset($data['allow_separate_shipping_address']) ? $data['allow_separate_shipping_address'] : false;
        $this->container['color_button'] = isset($data['color_button']) ? $data['color_button'] : null;
        $this->container['color_button_text'] = isset($data['color_button_text']) ? $data['color_button_text'] : null;
        $this->container['color_checkbox'] = isset($data['color_checkbox']) ? $data['color_checkbox'] : null;
        $this->container['color_checkbox_checkmark'] = isset($data['color_checkbox_checkmark']) ? $data['color_checkbox_checkmark'] : null;
        $this->container['color_header'] = isset($data['color_header']) ? $data['color_header'] : null;
        $this->container['color_link'] = isset($data['color_link']) ? $data['color_link'] : null;
        $this->container['date_of_birth_mandatory'] = isset($data['date_of_birth_mandatory']) ? $data['date_of_birth_mandatory'] : false;
        $this->container['shipping_details'] = isset($data['shipping_details']) ? $data['shipping_details'] : null;
        $this->container['title_mandatory'] = isset($data['title_mandatory']) ? $data['title_mandatory'] : false;
        $this->container['additional_checkbox'] = isset($data['additional_checkbox']) ? $data['additional_checkbox'] : null;
        $this->container['national_identification_number_mandatory'] = isset($data['national_identification_number_mandatory']) ? $data['national_identification_number_mandatory'] : false;
        $this->container['additional_merchant_terms'] = isset($data['additional_merchant_terms']) ? $data['additional_merchant_terms'] : null;
        $this->container['phone_mandatory'] = isset($data['phone_mandatory']) ? $data['phone_mandatory'] : false;
        $this->container['radius_border'] = isset($data['radius_border']) ? $data['radius_border'] : null;
        $this->container['allowed_customer_types'] = isset($data['allowed_customer_types']) ? $data['allowed_customer_types'] : null;
        $this->container['show_subtotal_detail'] = isset($data['show_subtotal_detail']) ? $data['show_subtotal_detail'] : false;
        $this->container['additional_checkboxes'] = isset($data['additional_checkboxes']) ? $data['additional_checkboxes'] : null;
        $this->container['verify_national_identification_number'] = isset($data['verify_national_identification_number']) ? $data['verify_national_identification_number'] : false;
        $this->container['show_vat_registration_number_field'] = isset($data['show_vat_registration_number_field']) ? $data['show_vat_registration_number_field'] : false;
    }
     ...
     *
     * @param bool $require_validate_callback_success If true, validate callback must get a positive response to not stop purchase. Default: false.
     *
     * @return $this
     */
     ...
     *
     * @param string $acquiring_channel Acquiring channel for the order. The possible values are: <ul><li><em>MOTO for \"Mail Order Telephone Order\"</em></li><li><em>ECOMMERCE for \"E-commerce\"</em></li><li><em>IN_STORE for \"Purchase in boutique\"</em></li><li><em>TELESALES for \"Telesales/telemarketing\"</em></li><li><em>Default : ECOMMERCE</em></li></ul>
     *
     * @return $this
     */
     ...
     * Sets vat_removed
     *
     * @param bool $vat_removed If true, VAT is not displayed in Checkout's Order Summary page.
     *
     * @return $this
     */
     ...
     *
     * @param bool $allow_separate_shipping_address If true, the consumer can enter different billing and shipping addresses. Default: false
     *
     * @return $this
     */
     ...
     * Sets color_button
     *
     * @param string $color_button Color for the buttons within the iFrame. Value should be a CSS hex color, e.g. \"#FF9900\"
     *
     * @return $this
     */
     ...
     *
     * @param string $color_button_text Color for the text inside the buttons within the iFrame. Value should be a CSS hex color, e.g. \"#FF9900\"
     *
     * @return $this
     */
     ...
     * Sets color_checkbox
     *
     * @param string $color_checkbox Color for the checkboxes within the iFrame. Value should be a CSS hex color, e.g. \"#FF9900\"
     *
     * @return $this
     */
     ...
     *
     * @param string $color_checkbox_checkmark Color for the checkboxes checkmark within the iFrame. Value should be a CSS hex color, e.g. \"#FF9900\"
     *
     * @return $this
     */
     ...
     * Sets color_header
     *
     * @param string $color_header Color for the headers within the iFrame. Value should be a CSS hex color, e.g. \"#FF9900\"
     *
     * @return $this
     */
     ...
     * Sets color_link
     *
     * @param string $color_link Color for the hyperlinks within the iFrame. Value should be a CSS hex color, e.g. \"#FF9900\"
     *
     * @return $this
     */
     ...
     *
     * @param bool $date_of_birth_mandatory If true, the consumer cannot skip date of birth. Default: false
     *
     * @return $this
     */
     ...
     *
     * @param string $shipping_details A message that will be presented on the confirmation page under the headline \"Delivery\" (max 255 characters).
     *
     * @return $this
     */
     ...
     *
     * @param bool $title_mandatory If specified to false, title becomes optional. Only available for orders for country GB.
     *
     * @return $this
     */
     ...
     *
     * @param bool $national_identification_number_mandatory If true, the user cannot skip national identification number in SE, NO, FI and DK. Default: false. In order to read the national identification number in the validation callback, please contact Klarna’s merchant support.
     *
     * @return $this
     */
     ...
     *
     * @param string $additional_merchant_terms Additional merchant defined field. e.g. Extra terms and conditions to show.  Example: \"ADDITIONAL MERCHANT TERMS! \\[terms link\\](https://merchant.com/extra_terms)\"
     *
     * @return $this
     */
     ...
     *
     * @param bool $phone_mandatory If false, the consumer can skip the phone. Only available for orders in DACH countries.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $allowed_customer_types A list of allowed customer types. Supported types: <b>person</b> & <b>organization</b>. Example: [\"person\",\"organization\"]
     *
     * @return $this
     */
     ...
     *
     * @param bool $show_subtotal_detail If true, the Order Detail subtotals view is expanded when the Klarna Checkout iFrame is loaded. Default: false
     *
     * @return $this
     */
     ...
     *
     * @param bool $verify_national_identification_number Enable verification of National Identification Numbers in Sweden and Norway.This option also make the national identification number mandatory
     *
     * @return $this
     */
     ...
     *
     * @param bool $show_vat_registration_number_field If true, a optional VAT registration number field will be shown in the address form. Only applies for b2b orders.
     *
     * @return $this
     */
