...
class Address implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['house_extension'] = isset($data['house_extension']) ? $data['house_extension'] : null;
     ...
     * Sets title
     *
     * @param string $title Title.<p>Valid values for UK:</p><ul><li><em>Mr</em></li><li><em>Ms</em></li><li><em>Mrs</em></li><li><em>Miss</em></li></ul><p>Valid values for DACH:</p><ul><li><em>Herr</em></li><li><em>Frau</em></li></ul><p>Valid values for NL:</p><ul><li><em>Dhr.</em></li><li><em>Mevr.</em></li></ul>
     *
     * @return $this
     */
     ...
     * Sets street_address
     *
     * @param string $street_address Street address, first line.
     *
     * @return $this
     */
     ...
     *
     * @param string $street_address2 Street address, second line.
     *
     * @return $this
     */
     ...
     * Sets street_name
     *
     * @param string $street_name Street name. Only applicable in DE/AT/NL. Do not combine with street_address. See <b>streetNumber</b>.
     *
     * @return $this
     */
     ...
     * Sets street_number
     *
     * @param string $street_number Street number. Only applicable in DE/AT/NL. Do not combine with street_address. See <b>streetName</b>.
     *
     * @return $this
     */
     ...
     *
     * @param string $house_extension House extension. Only applicable in NL
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code Postal/post code.
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string $country ISO 3166 alpha-2. Country.
     *
     * @return $this
     */
