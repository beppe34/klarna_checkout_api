...
class ProductIdentifiers implements ModelInterface, ArrayAccess
{
     ...
     * Sets category_path
     *
     * @param string $category_path The product's category path as used in the merchant's webshop. Include the full and most detailed category and separate the segments with ' > '. (max 750 characters)  Example: \"Electronics Store > Computers & Tablets > Desktops\"
     *
     * @return $this
     */
